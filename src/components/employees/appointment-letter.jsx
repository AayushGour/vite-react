...
const AppointmentLetterComponent = (props) => {
    ...
    const constructDocDefinition = async () => {
        ...
        const docDef = [
                ...
                columns: [
                    ...
                    },
                    {
                        text: [
                            ...
                            "Address: Lorem ipsum dolor sit amet, consectetur adipisicing elit. Confectum ponit legam, perferendis nomine miserum, animi. Moveat nesciunt triari naturam posset\n",
                        ],
                        style: "regular"
                    },
                ]
            ...
            },
            {
                ol: [
                    {
                        text: [
                            'With reference to your application for employment and the subsequent interviews you had with us, we are pleased to offer you an appointment as SECURITY SUPERVISOR w.e.f. 19-07-23 in out organization on the following terms and conditions: -\n\nYou will be paid a gross salary of Rs……15932…….  /- Only (Rupees as per statutory post and grade) per month.\n\n',
                            {
                                text: "ಉದ್ಯೋಗಕ್ಕಾಗಿ ನಿಮ್ಮ ಅರ್ಜಿ ಮತ್ತು ನೀವು ನಮ್ಮೊಂದಿಗೆ ನಡೆಸಿದ ನಂತರದ ಸಂದರ್ಶನಗಳನ್ನು ಉಲ್ಲೇಖಿಸಿ, ಈ ಕೆಳಗಿನ ನಿಯಮಗಳು ಮತ್ತು ಷರತ್ತುಗಳ ಮೇಲೆ ನಮ್ಮ ಸಂಸ್ಥೆಯಲ್ಲಿ 19-07-23 ರಂದು SECURITY SUPERVISOR ಯಾಗಿ ನಿಮಗೆ ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್ ನೀಡಲು ನಾವು ಸಂತೋಷಪಡುತ್ತೇವೆ: -\n\nನಿಮಗೆ ತಿಂಗಳಿಗೆ ರೂ.15932/- ಮಾತ್ರ (ಕಾನೂನುಬದ್ಧ ಹುದ್ದೆ ಮತ್ತು ದರ್ಜೆಯ ಪ್ರಕಾರ ರೂಪಾಯಿಗಳು) ಒಟ್ಟು ವೇತನವನ್ನು ನೀಡಲಾಗುವುದು.\n\n",
                                font: "Kannada-font",
                                lineHeight: 1.2,
                            },
                        ],
            ...
            { text: "For M/s SLR GUARDING SOLUTIONS PVT LTD\n\n\n\n\nAuthorized Signatory\n\n\n\n", font: "Times-New-Roman", bold: true },
    ...
    return (
        <div className="h-100 w-100 appointment-letter-container d-flex flex-row px-5 py-4">
            <div className="w-50 h-100"></div>
            <PdfPreview className="w-50 h-100" docDefinition={{ content: docDefinition, styles: styles }} key={1} />
        </div>
    )
}
