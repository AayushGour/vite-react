...
import { deleteClientByIdUrl, getClientsListUrl } from '../utility/api-urls';
...
const ManageClientsComponent = (props) => {
    ...
    const handleDeleteClientClick = (record) => {
        Modal.confirm({
            title: `Are you sure you want to delete "${record?.clientName}"`,
            onOk: () => deleteClient(record?._id)
        })
    }
        ...
        },
        {
            ...
            render: (text, record) => {
                return <div className="d-flex align-items-center">
                    ...
                    <Link to={`/manage-clients/${record?._id}`} style={{ marginRight: '1rem' }}>
                    ...
                    <div style={{ cursor: "pointer" }} onClick={() => handleDeleteClientClick(record)}>
